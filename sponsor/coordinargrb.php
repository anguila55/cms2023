...
<?
	...
	$query="SELECT MSGTITULO,MSGDESCRI, MSGSUB, MSGBOT, MSGLNK, MSGIMG FROM MSG_CABE WHERE MSGREG=9";
		...
		if($reureg==0){
			...
			if($correodst!=''){
				...
				<div style="text-align:center">
					<img src=' . getUrl("/mailsimg/9/$msgimg") . ' alt="image.png" style="max-width: 800px; height:auto; margin-right:0px" data-image-whitelisted="" class="CToWUd">
				...
				<div dir="ltr">
					...
					<div style="text-align:center; margin-top: 30px;">
						<b><a style="background-color: grey;color:white;padding: 15px;font-size: 15px;border-radius:20px;text-decoration: none;" href="' . URL_WEB . 'reuniones/bsq?T=2">'.$msgbot.'</a></b>
					</div>
				</div>
			</body>
			</html>';
