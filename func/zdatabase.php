...
//***************agregado 24-04-2023**** */
function SQL_replace($str_,$pass_ = false) {
	...
	$str_ = str_replace ("'", "", $str_);
	$str_ = str_replace ("\\", "", $str_);
	$str_ = str_ireplace("insert","",$str_);
	$str_ = str_ireplace(" into ","",$str_);
	$str_ = str_ireplace("update","",$str_);
	$str_ = str_ireplace("delete","",$str_);
	$str_ = str_ireplace("select","",$str_);
	$str_ = str_ireplace("drop","",$str_);
	$str_ = str_ireplace("Character","",$str_);
	$str_ = str_ireplace("MEMB_INFO","",$str_);
 	$str_ = str_ireplace(" IN ","",$str_);
	$str_ = str_ireplace(" IN ","",$str_);
 	$str_ = str_ireplace(" OR ","",$str_);
 	$str_ = str_replace (";", "", $str_);
	$str_ = str_replace ("\x00", "", $str_);
	$str_ = str_replace ("\x1a", "", $str_);
	//$str_ = str_replace (",", "", $str_);
