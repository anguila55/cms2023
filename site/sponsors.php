...
$tmpl->loadTemplateFile('sponsors.html');
...
for ($i = 0; $i < $Table->Rows_Count; $i++) {
	...
	switch ($expcatego) {
		case 'Gold':
			...
			$tmpl->setVariable('explinkedo', $explinked);
		...
		case 'Silver':
			...
			$tmpl->setVariable('explinkeds', $explinked);
		...
		case 'Bronze':
			...
			$tmpl->setVariable('explinkedb', $explinked);
    ...
    // $contador ++;
    //         $tmpl->setVariable('contador', $contador);
    //         logerror($contador);
