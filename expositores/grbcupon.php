...
<?
	...
	$expcupvid      = (isset($_POST['expcupvid']))? trim($_POST['expcupvid']):'';
	$expcupval      = (isset($_POST['expcupval']))? trim($_POST['expcupval']):'';
	$seccodigo      = (isset($_POST['seccodigo']))? trim($_POST['seccodigo']):'';
	$secsubcod      = (isset($_POST['secsubcod']))? trim($_POST['secsubcod']):'';
	$secclase      = (isset($_POST['secclase']))? trim($_POST['secclase']):'';
	$seclad      = (isset($_POST['seclad']))? trim($_POST['seclad']):'';
	...
	$expcupvid		= VarNullBD($expcupvid		, 'S');
	...
	if($expcupreg==0){
		...
		$query = " 	INSERT INTO EXP_CUPO (EXPREG,EXPCUPREG,EXPCUPTIT,EXPCUPDES,EXPCUPVAL,ESTCODIGO,EXPCUPZON,EXPCUPFCH,EXPCUPCAR1,EXPCUPCAR2,EXPCUPCAR3,EXPCUPCAR4,EXPCUPCAR5,EXPCUPCAR6,EXPCUPCAR7,EXPCUPCAR8,EXPCUPCAR9,EXPCUPCAR10,EXPCUPCAR11,EXPCUPVID)
					VALUES($expreg,$expcupreg,$expcuptit,$expcupdes,$expcupval,$estcodigo,$expcupzon,CURRENT_TIMESTAMP,$expcupcar1,$expcupcar2,$expcupcar3,$expcupcar4,$expcupcar5,$expcupcar6,$expcupcar7,$expcupcar8,$expcupcar9,$expcupcar10,$expcupcar11,$expcupvid) ";
	}else{
		$query = " 	UPDATE EXP_CUPO  SET 
					EXPCUPTIT=$expcuptit,EXPCUPDES=$expcupdes,EXPCUPVAL=$expcupval,ESTCODIGO=$estcodigo,EXPCUPZON=$expcupzon,EXPCUPCAR1=$expcupcar1,EXPCUPCAR2=$expcupcar2,EXPCUPCAR3=$expcupcar3,EXPCUPCAR4=$expcupcar4,EXPCUPCAR5=$expcupcar5,EXPCUPCAR6=$expcupcar6,EXPCUPCAR7=$expcupcar7,EXPCUPCAR8=$expcupcar8,EXPCUPCAR9=$expcupcar9,EXPCUPCAR10=$expcupcar10,EXPCUPCAR11=$expcupcar11, EXPCUPVID=$expcupvid
