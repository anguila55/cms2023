...
$tmpl->loadTemplateFile('ticket.html');
DDIdioma($tmpl);
...
$query = "	SELECT P.PERCODIGO,P.PERNOMBRE,P.PERAPELLI,P.PERAVATAR,P.PERCOMPAN,P.PERCARGO,P.QRCODE,P.PERCLASE,PC.PERCLADES
				FROM PER_MAEST P
				LEFT OUTER JOIN PER_CLASE PC ON P.PERCLASE = PC.PERCLASE 
