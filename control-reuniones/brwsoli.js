function Eliminarsoli(){
    ...
    document.querySelector("#horariossoli").innerHTML='';

}
function Mostrarsoli(producto){
    ...
    if(producto.horadisabled==1){
        ...
        horas.innerHTML = `<div class="container-disponibilidad d-block">
            ...
            <input type="checkbox" id="coordtime${producto.horaid}" name="coordtime" class="switchery d-none"
                ...
                data-hora="${producto.horabd}" ${horadisabled} onclick='handleClick1(this);'/>
    ...
    if (horas != ''){
        document.querySelector("#horariossoli").appendChild( horas );
    }
    }