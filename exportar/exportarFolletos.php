...
<?
    ...
    $conn= sql_conectar();//Apertura de Conexion
        ...
        $query="SELECT DISTINCT PS.PERNOMBRE AS SOLNOMBRE,PS.PERAPELLI AS SOLAPELLI,PS.PERCOMPAN AS SOLEMPRESA,PS.PERCORREO AS SOLCORREO,
					PD.PRODNOMBRE AS DSTEMPRESA, Q.GAMEFCH AS FECHAEMPRESA
				FROM GAME_PTS Q
				LEFT OUTER JOIN PER_MAEST PS ON PS.PERCODIGO=Q.PERCODIGO
                LEFT OUTER JOIN EXP_PROD PD ON PD.PRODREG=Q.VALOR
				WHERE PS.PERCODIGO IS NOT NULL AND Q.TIPO=9 AND PD.PRODREG= Q.VALOR $and
				ORDER BY Q.GAMEFCH ";
    ...
    $objPHPExcel->getActiveSheet()
                ...
                ->setCellValue('E1', 'Nombre Folleto')
    ...
    header('Content-Disposition: attachment;filename="ExportarFolletos.xlsx"');
