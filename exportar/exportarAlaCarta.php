...
<?
    ...
    $conn= sql_conectar();//Apertura de Conexion
        ...
        $query="SELECT DISTINCT PS.PERNOMBRE AS SOLNOMBRE,PS.PERAPELLI AS SOLAPELLI,PS.PERCOMPAN AS SOLEMPRESA,PS.PERCORREO AS SOLCORREO,
					PD.VIDTITULO AS DSTEMPRESA , Q.GAMEFCH AS FECHAEMPRESA
				FROM GAME_PTS Q
				LEFT OUTER JOIN PER_MAEST PS ON PS.PERCODIGO=Q.PERCODIGO
                LEFT OUTER JOIN VID_MAEST PD ON PD.VIDREG=Q.VALOR
				WHERE PS.PERCODIGO IS NOT NULL AND Q.TIPO=11 AND PD.VIDREG= Q.VALOR $and
				ORDER BY Q.GAMEFCH ";
    ...
    $objPHPExcel->getActiveSheet()
                ...
                ->setCellValue('E1', 'Empresa A la Carta')
    ...
    header('Content-Disposition: attachment;filename="ExportarOnDemand.xlsx"');
