...
<?
    ...
    $conn= sql_conectar();//Apertura de Conexion
        ...
        $query="SELECT DISTINCT PS.PERNOMBRE AS SOLNOMBRE,PS.PERAPELLI AS SOLAPELLI,PS.PERCOMPAN AS SOLEMPRESA,PS.PERCORREO AS SOLCORREO,
					PD.AGETITULO AS DSTEMPRESA, Q.AGEPREGUN AS TIPOEMPRESA
				FROM AGE_PREG Q
				LEFT OUTER JOIN PER_MAEST PS ON PS.PERCODIGO=Q.PERCODIGO
                LEFT OUTER JOIN AGE_MAEST PD ON PD.AGEREG=Q.AGEREG
				WHERE PS.PERCODIGO IS NOT NULL
				ORDER BY Q.AGEPREITM ";
    ...
    $objPHPExcel->getActiveSheet()
                ...
                ->setCellValue('E1', 'Nombre Charla')
                ->setCellValue('F1', 'Pregunta');
            ...
            for($i=0; $i<$Table->Rows_Count; $i++){
                    ...
                    $objPHPExcel->getActiveSheet()->setCellValue('F'.$ii, $tipoempresa);
    ...
    header('Content-Disposition: attachment;filename="ExportarPreguntas.xlsx"');
