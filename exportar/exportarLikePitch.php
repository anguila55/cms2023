...
<?
    ...
    $conn= sql_conectar();//Apertura de Conexion
        ...
        $query="SELECT DISTINCT PS.PERNOMBRE AS SOLNOMBRE,PS.PERAPELLI AS SOLAPELLI,PS.PERCOMPAN AS SOLEMPRESA,PS.PERCORREO AS SOLCORREO,
					PD.PITCH_EMP AS DSTEMPRESA, Q.GAMEFCH AS FECHAEMPRESA
				FROM GAME_PTS Q
				LEFT OUTER JOIN PER_MAEST PS ON PS.PERCODIGO=Q.PERCODIGO
                LEFT OUTER JOIN PITCH_MAEST PD ON PD.PITCH_REG=Q.VALOR
				WHERE Q.PERCODIGO IS NOT NULL AND Q.TIPO=10 $and
				ORDER BY Q.GAMEFCH ";
    ...
    header('Content-Disposition: attachment;filename="ExportarLikesPitch.xlsx"');
