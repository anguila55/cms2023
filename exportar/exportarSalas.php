...
<?
    ...
    $conn= sql_conectar();//Apertura de Conexion
        ...
        $query="SELECT DISTINCT PS.PERNOMBRE AS SOLNOMBRE,PS.PERAPELLI AS SOLAPELLI,PS.PERCOMPAN AS SOLEMPRESA,PS.PERCORREO AS SOLCORREO,
					PD.AGETITULO AS DSTEMPRESA , Q.GAMEFCH AS FECHAEMPRESA
				FROM GAME_PTS Q
				LEFT OUTER JOIN PER_MAEST PS ON PS.PERCODIGO=Q.PERCODIGO
                LEFT OUTER JOIN AGE_MAEST PD ON PD.AGEREG=Q.VALOR
				WHERE PS.PERCODIGO IS NOT NULL AND Q.TIPO=1 AND PD.AGEREG= Q.VALOR $and
				ORDER BY Q.GAMEFCH ";
    ...
    header('Content-Disposition: attachment;filename="ExportarSalas.xlsx"');
